...
This graph shows the dependency of each function. For example Prefix to parse tree requires the input infix to be converted top prefix first, hence it requires the function of the first task. \hypertarget{md_Profiling_autotoc_md11}{}\doxysubsection{Memory Usage Graph}\label{md_Profiling_autotoc_md11}
 
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{memory_profile.jpeg}
\doxyfigcaption{Memory Usage Graph}
\end{DoxyImage}
  \hypertarget{md_Profiling_autotoc_md12}{}\doxysection{Analysis}\label{md_Profiling_autotoc_md12}
\hypertarget{md_Profiling_autotoc_md13}{}\doxysubsection{Time Analysis}\label{md_Profiling_autotoc_md13}
...
One can observe sharp variations in data, which we consider as experimental error.\hypertarget{md_Profiling_autotoc_md14}{}\doxysection{Conclusion}\label{md_Profiling_autotoc_md14}
